 ...
 *
 */
public class TyeeModernRoboticsColorSensor extends ColorSensor implements I2cController.I2cPortReadyCallback {
    ...
    public TyeeModernRoboticsColorSensor(DeviceInterfaceModule deviceInterfaceModule, int physicalPort) {
