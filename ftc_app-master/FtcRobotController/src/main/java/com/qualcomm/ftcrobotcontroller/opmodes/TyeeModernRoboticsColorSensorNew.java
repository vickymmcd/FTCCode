 ...
 *
 */
public abstract class TyeeModernRoboticsColorSensorNew extends ColorSensor implements I2cController.I2cPortReadyCallback {
    ...
    public TyeeModernRoboticsColorSensorNew(DeviceInterfaceModule deviceInterfaceModule, int physicalPort) {
