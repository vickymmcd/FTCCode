 ...
 *
 */
public class TyeeModernRoboticsColorSensorX52 extends ColorSensor implements I2cController.I2cPortReadyCallback {
    public static volatile int ADDRESS_I2C = 0x52;
    ...
    public TyeeModernRoboticsColorSensorX52(DeviceInterfaceModule deviceInterfaceModule, int physicalPort) {
