...
/*
 * An autonomous program for pressing the appropriate buttons,
 * dropping the climbers, and driving up the mountain
 */
public class APSAutoMountainLeft2 extends PushBotHardwareSensors2 {
    DcMotor leftMotor;
    DcMotor rightMotor;
           ...
           /*     case 6:
                ...
                case 8:
                  ...
                  //  sleep(10000);
                    ...
                    break;
                case 9:
                    v_servo_left_side.setPosition(0);
                    v_servo_left_side.setPosition(.67);
                    // telemetry.addData("gyro value: ", zsensor.getRotation());
                    DriveForwardTime(.25, 500);
                    TurnRightTime(.25, 700);
                    DriveForwardTime(.25, 600);
                    TurnRightTime(.25, 500);
                    DriveForwardTime(.25, 800);
                    TurnRightTime(.25, 1500);
                    DriveForwardTime(.25, 700);
