 ...
 */
public class APSAuto4 extends PushBotHardwareSensors

{
...

    {
        ...
        l_left_drive_power=1;
        l_right_drive_power=1;

        set_drive_power (l_left_drive_power, l_right_drive_power);


        if (a_left_encoder_count() > 800) {
            set_drive_power(1, -1);
            if(a_left_encoder_count() > 900){
                set_drive_power(1,1);
                if(a_left_encoder_count()>2000)
                    set_drive_power(0,0);
            }
        }
